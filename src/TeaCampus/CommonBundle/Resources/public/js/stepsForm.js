...
;( function( window ) {
	...
	stepsForm.prototype._init = function() {
		...
		this.ctrlPrev = this.el.querySelector( 'button.previous' );
	...
	stepsForm.prototype._resetForm = function() {
		this.current = 0;
	...
	stepsForm.prototype._nextQuestion = function() {
		...
		if( !this.isFilled ) {
			...
			classie.removeClass( nextQuestion, 'previous-question' );
			classie.removeClass( currentQuestion, 'previous-question' );
		}
		...
		if( !this.isFilled ) {
			...
			// add class "show-prev" to form element (start animations)
			...
			classie.addClass( nextQuestion, 'current' );
			classie.removeClass( nextQuestion, 'previous-question' );
			classie.addClass( currentQuestion, 'previous-question' );
		}

		// after animation ends, remove class "show-prev" from form element and change current question placeholder
		var self = this,
			onEndTransitionFn = function( ev ) {
				if( support.transitions ) {
					this.removeEventListener( transEndEventName, onEndTransitionFn );
	...
	stepsForm.prototype._showError = function( err ) {
		...
		switch( err ) {
			...
			case 'INVALIDEMAIL' : 
				...
				break;
			case 'NUMBERSTR' : 
				message = 'Ce champ doit être un entier';
				break;
			// ...
		};
